        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
              <Card className="p-4 bg-white border border-slate-200/90 shadow-soft">
                ...
                <p className="text-[11px] text-slate-500 mt-0.5">Highest execution rate</p>
              </Card>
              ...
              <Card className="p-4 bg-white border border-slate-200/90 shadow-soft">
                ...
                <p className="text-[11px] text-slate-500 mt-0.5">Most frequent completions</p>
              </Card>
              ...
              <Card className="p-4 bg-white border border-slate-200/90 shadow-soft">
                ...
                <p className="text-[11px] text-slate-500 mt-0.5">Strongest habit loop</p>
              </Card>
              ...
              <Card className="p-4 bg-white border border-slate-200/90 shadow-soft">
                ...
                <p className="text-[11px] text-slate-500 mt-0.5">Compounding momentum</p>
              </Card>
            </div>
