  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] text-slate-900 flex flex-col justify-center py-8 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md flex items-center justify-between mb-5 px-1">
        <Link href="/welcome" className="inline-block group">
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    This is how you'll be addressed throughout DayForge.
                  </p>
                </div>
                ...
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="w-full font-black text-sm rounded-2xl mt-4 min-h-[48px] shadow-md shadow-[#6C5CE7]/25"
            ...
            {step === 2 && (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Choose a stylized character to represent your persona.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3 pt-2">
                  <Button
                    ...
                    size="md"
                    onClick={() => setStep(1)}
                    className="font-bold text-slate-600 rounded-2xl min-h-[44px]"
                  ...
                  <Button
                    ...
                    className="flex-1 font-black text-sm rounded-2xl min-h-[48px] shadow-md shadow-[#6C5CE7]/25"
                    rightIcon={<ArrowRight className="w-4 h-4 stroke-[2.5]" />}
                  >
            ...
            {step === 3 && (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Your unique username and login email address.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="alex_forger"
                      className="w-full pl-9 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-semibold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#6C5CE7] min-h-[44px]"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-11 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-semibold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#6C5CE7] min-h-[44px]"
                    />
                    <button
                      type="button"
