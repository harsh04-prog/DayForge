  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-center">
        <div className="inline-flex p-1 bg-slate-100 border border-slate-200/80 rounded-2xl">
          <button
            type="button"
            ...
            return (
              <motion.button
                ...
                className={`relative flex flex-col items-center p-3 rounded-3xl transition-all text-center select-none group border ${
                  isSelected
                    ? 'border-[#6C5CE7] bg-[#6C5CE7]/10 ring-2 ring-[#6C5CE7]/30 shadow-md'
                    : 'border-slate-200/80 bg-white hover:border-[#6C5CE7]/40 hover:shadow-soft'
                }`}
              >
                ...
                {/* Avatar 3D Preview */}
                <div className="w-16 h-16 sm:w-18 sm:h-18 rounded-2xl overflow-hidden mb-2 relative shadow-xs bg-slate-50 border border-slate-100">
                  <img
                    src={avatar.svg}
                    alt={avatar.name}
