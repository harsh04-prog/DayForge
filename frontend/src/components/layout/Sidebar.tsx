    ...
    <aside className="w-72 sm:w-80 lg:w-64 h-full bg-white border-r border-slate-200/80 flex flex-col justify-between p-4 sm:p-5 overflow-y-auto">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between px-1 pt-1">
          <NavLink to="/" onClick={onCloseMobile} className="inline-block group">
          ...
          {navItems.map((item) => {
            ...
            return (
              <NavLink
                ...
                onClick={onCloseMobile}
                className={({ isActive }) =>
                  `flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-bold transition-all duration-150 select-none min-h-[44px] ${
                    isActive
