...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        'bg-slate-100 dark:bg-[#1E2232] text-slate-800 dark:text-slate-100 hover:bg-slate-200 dark:hover:bg-[#282E44] border border-slate-200/80 dark:border-[#2E3348] focus:ring-slate-400',
      outline:
        'bg-transparent border border-slate-300 dark:border-[#2E3348] text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-[#1E2232] focus:ring-slate-400',
      ghost:
        'bg-transparent text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-[#1E2232] hover:text-slate-900 dark:hover:text-white focus:ring-slate-400',
      danger:
